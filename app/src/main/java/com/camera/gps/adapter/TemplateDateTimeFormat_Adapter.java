...
public class TemplateDateTimeFormat_Adapter extends RecyclerView.Adapter<TemplateDateTimeFormat_Adapter.MyViewHolder> {
    ...
    public TemplateDateTimeFormat_Adapter(Context context, ArrayList<DateFormatModel> arrayList, DateClicksListener dateClicksListener) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        // Set the formatted date text using the combined format
        myViewHolder.txt_note.setText(this.helperClass.setDateTime(
                dateFormatModel.getFormat_Combined(), // Use combined format
                this.msp.getString(this.mContext, MyApplication.TIMEZONE_FORMAT,
                        this.time_list.size() > 5 ? this.time_list.get(5).getFormat_Combined() : "GMT"),
                this.mContext));
    ...
    public int getItemCount() {
        return this.time_list != null ? this.time_list.size() : 0;
    }
    ...
    public DateFormatModel getSelectedFormat() {
        ...
        if (selectedPos >= 0 && time_list != null && selectedPos < time_list.size()) {
